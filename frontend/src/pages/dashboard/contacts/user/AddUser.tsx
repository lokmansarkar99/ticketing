        ...
        <div className="mt-5 flex flex-col gap-3" >
          ...
          <label className="flex items-center gap-1.5">
            <Input
              ...
              className="w-5 h-5"
            />
            {translate("সব কোচ ইনভয়েস দেখুন", "View All Coach Invoice? (Permission required countermaster/callcenter)")}
          </label>
          ...
          <label className="flex items-center gap-1.5">
            <Input
              ...
              className="w-5 h-5"
            />
            {translate("ডিসকাউন্ট ব্লক করুন", "Block Discount (Apply for countermaster/callcenter)")}
          </label>
          ...
          <label className="flex items-center gap-1.5">
            <Input
              ...
              className="w-5 h-5"
            />
            {translate("ভিআইপি সিট বিক্রির অনুমতি", "VIP Seat Allow to Sale (Permission required countermaster/callcenter)")}
          </label>
          <label className="flex items-center gap-1.5">
            <Input
              type="checkbox"
